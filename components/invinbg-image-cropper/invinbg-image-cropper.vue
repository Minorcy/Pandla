<template>
    <view class="vue-cropper" ref="cropper" :style="{ top : `${containerTop}px` }" v-show="show">
        <view class="cropper-box">
			<!-- @touchstart.stop.prevent="imgTouchStart" @touchmove.stop.prevent="imgMoveing" @touchend.stop.prevent="imgMoveEnd" -->
            <view class="cropper-box-canvas" :style="{
					'width': imageWidth + 'px',
        ...
        <view class="uni-info__ft">
            <view class="uni-modal__btn uni-modal__btn_default" style="color: #4A4A4A;" @tap="cancel">取消</view>
            <view class="uni-modal__btn uni-modal__btn_primary" style="color: #4A4A4A;" @tap="confirm">确定</view>
        </view>
    </view>
</template>
...
<script>
    export default {
        ...
        methods: {
			...
			// const imgW = _this.imageWidth / _this.imageRatio;
			// const imgH = _this.imageHeight / _this.imageRatio
