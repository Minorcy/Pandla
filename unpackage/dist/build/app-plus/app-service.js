...
__wxAppCode__['pages/daily/daily.json']={"enablePullDownRefresh":true,"navigationBarTitleText":"","titleNView":false,"usingComponents":{"barrage":"/components/barrage"}};
  ...
  b04d: function b04d(t, e, n) {
    ...
    (function (t) {
      ...
      var u = {
        ...
        methods: {
          OnCanvas: function () {
            var e = l(i.default.mark(function e() {
              var n, a, c, l, u, o, s, f, x, p, d, g, T;
                  ...
                  switch (e.prev = e.next) {
                    case 0:
                      return t.showLoading({
                        title: "生成海報中"
                      }), r.ctx = t.createCanvasContext(r.CanvasID, this), n = t.upx2px(r.Width), a = t.upx2px(30), c = t.upx2px(150), l = 0, e.next = 6, r.getImageInfo({
                        imgSrc: r.imgSrc
                      });

                    case 6:
                      return u = e.sent, e.next = 9, r.getImageInfo({
                        imgSrc: r.QrSrc
                      });

                    case 9:
                      o = e.sent, s = [u.width, u.height], f = [o.width, o.height], x = n - 2 * a, s[0] != x && (s[1] = Math.floor(x / s[0] * s[1]), s[0] = x), f[0] != c && (f[1] = Math.floor(c / f[0] * f[1]), f[0] = c), r.canvasW = n, r.canvasH = s[1] + f[1] + 128, r.ctx.setFillStyle(r.CanvasBg), r.ctx.fillRect(0, 0, n, r.canvasH), r.ctx.drawImage(u.path, a, a, s[0], s[1]), r.ctx.setFontSize(t.upx2px(28)), r.ctx.setFillStyle(r.TitleColor), p = 0, d = s[1] + 2 * a + 10, g = 1, T = 0;
                    ...
                    case 26:
                      ...
                      return r.ctx.fillText(r.Title.substring(p, T - 8) + "...", a, d), l = 0, p = T, g++, e.abrupt("break", 48);

                    case 37:
                      r.ctx.fillText(r.Title.substring(p, T), a, d), l = 0, d += 20, p = T, g++;
                    ...
                    case 44:
                      T == r.Title.length - 1 && (r.ctx.fillText(r.Title.substring(p, T + 1), a, d), l = 0);
                    ...
                    case 48:
                      l = a, d += t.upx2px(60), 1 == g && (d += 20), "" != r.PriceTxt && (r.ctx.setFillStyle(r.PriceColor), r.ctx.setFontSize(t.upx2px(38)), r.ctx.fillText(r.PriceTxt, l, d), l += r.ctx.measureText(r.PriceTxt).width + t.upx2px(10)), "" != r.PriceTxt && "" != r.OriginalTxt && (r.ctx.setFillStyle(r.OriginalColor), r.ctx.setFontSize(t.upx2px(24)), r.ctx.fillText(r.OriginalTxt, l, d)), r.ctx.strokeStyle = r.OriginalColor, r.ctx.moveTo(l, d - t.upx2px(10)), r.ctx.lineTo(l + r.ctx.measureText(r.OriginalTxt).width, d - t.upx2px(10)), r.ctx.stroke(), d += t.upx2px(20), r.ctx.drawImage(o.path, s[0] - f[0] + a, d, f[0], f[1]), r.ctx.setFillStyle(r.TitleColor), r.ctx.setFontSize(t.upx2px(30)), r.ctx.fillText(r.Referrer, a, d + f[1] / 2), r.ctx.setFillStyle(r.OriginalColor), r.ctx.setFontSize(t.upx2px(24)), r.ctx.fillText(r.ViewDetails, a, d + f[1] / 2 + 20), setTimeout(function () {
          ...
          getNewImage: function getNewImage() {
            t.canvasToTempFilePath({
              ...
              complete: function complete(e) {
                t.hideLoading(), r.$emit("success", e);
              }
            }, this);
          }
        },
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/main/main"],{"0437":function(n,t,e){},"3c01":function(n,t,e){"use strict";e.r(t);var a=e("e0ad"),u=e.n(a);for(var i in a)"default"!==i&&function(n){e.d(t,n,function(){return a[n]})}(i);t["default"]=u.a},8837:function(n,t,e){"use strict";e.r(t);var a=e("cc95"),u=e("3c01");for(var i in u)"default"!==i&&function(n){e.d(t,n,function(){return u[n]})}(i);e("da18");var c=e("2877"),o=Object(c["a"])(u["default"],a["a"],a["b"],!1,null,"4c0c8fbc",null);t["default"]=o.exports},cc95:function(n,t,e){"use strict";var a=function(){var n=this,t=n.$createElement;n._self._c},u=[];e.d(t,"a",function(){return a}),e.d(t,"b",function(){return u})},da18:function(n,t,e){"use strict";var a=e("0437"),u=e.n(a);u.a},e0ad:function(n,t,e){"use strict";(function(n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=e("f80b"),u=(e("2f62"),function(){return e.e("components/token").then(e.bind(null,"a328"))}),i={data:function(){return{slides:"",indicatorDots:!1,autoplay:!1,interval:2e3,duration:500,circular:!1,currentSwiper:0,tokens:[{value:"0.0214"},{value:"0.0872"},{value:"0.0476"},{value:"0.0013"},{value:"0.0013"},{value:"0.0048"}]}},components:{token:u},methods:{toPan:function(){n.switchTab({url:"../pan/pan"})},getMainSlider:function(){var n=this;(0,a.mainSlider)().then(function(t){n.slides=t})}},onLoad:function(){this.getMainSlider()}};t.default=i}).call(this,e("6e42")["default"])}},[["5986","common/runtime","common/vendor"]]]);
});
