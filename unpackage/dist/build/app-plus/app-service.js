                  ...
                  switch (e.prev = e.next) {
                    case 0:
                      return t.showLoading({
                        title: "生成海報中"
                      }), i.ctx = t.createCanvasContext(i.CanvasID, this), n = t.upx2px(i.Width), a = t.upx2px(30), l = t.upx2px(200), c = 0, e.next = 6, i.getImageInfo({
                        imgSrc: i.imgSrc
                      });
                    ...
                    case 9:
                      o = e.sent, s = [u.width, u.height], x = [o.width, o.height], f = n - 2 * a, s[0] != f && (s[1] = Math.floor(f / s[0] * s[1]), s[0] = f), x[0] != l && (x[1] = Math.floor(l / x[0] * x[1]), x[0] = l), i.canvasW = n, i.canvasH = s[1] + x[1] + 28, i.ctx.setFillStyle(i.CanvasBg), i.ctx.fillRect(0, 0, n, i.canvasH), i.ctx.drawImage(u.path, a, a, s[0], s[1]), i.ctx.setFontSize(t.upx2px(30)), i.ctx.setFillStyle(i.TitleColor), p = 0, d = s[1] + 2 * a + 10, g = 1, T = 0;
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/daily/daily"],{"0201":function(n,t,e){"use strict";e.r(t);var i=e("8a0a"),o=e("bfc9");for(var c in o)"default"!==c&&function(n){e.d(t,n,function(){return o[n]})}(c);e("1da4");var s=e("2877"),u=Object(s["a"])(o["default"],i["a"],i["b"],!1,null,"55ae9197",null);t["default"]=u.exports},"1da4":function(n,t,e){"use strict";var i=e("eecd"),o=e.n(i);o.a},"8a0a":function(n,t,e){"use strict";var i=function(){var n=this,t=n.$createElement;n._self._c},o=[];e.d(t,"a",function(){return i}),e.d(t,"b",function(){return o})},"959c":function(n,t,e){"use strict";(function(n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var i=e("d16c"),o=function(){return e.e("components/barrage").then(e.bind(null,"f0d7"))},c={components:{barrage:o},data:function(){return{dynInfo:"",commentInfo:"",bulletList:"",following:!1,did:0,uid:0,cid:0,beStatus:!1,commContent:"",commplaceholder:"  添加評論",addType:"",array:["取消關注","屏蔽用戶","舉報用戶"],pickIndex:0,likeNumber:0,comClass:"comment-section"}},methods:{findDyn:function(n){var t=this;(0,i.findAllDyn)().then(function(e){t.dynInfo=e,1==n&&(t.did=t.dynInfo[0].id,t.uid=t.dynInfo[0].uid),(0,i.getBullet)(t.did).then(function(n){t.bulletList=n.content}),(0,i.getComment)(t.did).then(function(n){t.commentInfo=n})})},goBack:function(){n.switchTab({url:"../main/main"})},publishDyn:function(){var t=this;(0,i.getImgTemp)().then(function(e){t.$store.commit("setImgTemp",e),console.log(t.$store.state.imgTemp," at pages\\daily\\daily.vue:156"),n.navigateTo({url:"publish"})})},userFollow:function(){var n=this;0==this.following&&(0,i.concern)(1,this.uid).then(function(t){n.following=!0,n.findDyn(2)})},bindPickerChange:function(n){var t=this;this.pickIndex=n.target.value,0==n.target.value&&(this.following=!1,console.log(this.uid," at pages\\daily\\daily.vue:178"),(0,i.concern)(2,this.uid).then(function(n){t.findDyn()}))},behaviour:function(){0==this.beStatus?this.beStatus=!0:1==this.beStatus&&(this.beStatus=!1)},userInfo:function(){n.navigateTo({url:"/pages/daily/userInfo?uid="+this.uid})},likePerson:function(t){1==t?n.showToast({icon:"none",title:"不可以給自己點贊哦"}):((0,i.like)(this.did,1),this.findDyn(2))},endLike:function(){n.showToast({icon:"none",title:"结束触摸，点击了"+this.likeNumber+"次"})},showComm:function(){"comment-section"==this.comClass?this.comClass="comment-section-details":this.comClass="comment-section"},swiperChange:function(n){var t=this;this.following=!1,this.comClass="comment-section",this.addType="",this.commplaceholder="  添加評論",this.commentInfo="",this.did=this.dynInfo[n.detail.current].id,this.uid=this.dynInfo[n.detail.current].uid,(0,i.getBullet)(this.did).then(function(n){t.bulletList=n.content}),(0,i.getComment)(this.did).then(function(n){t.commentInfo=n})},addComm:function(){var n=this;""!=this.commContent&&("reply"==this.addType?(0,i.reply)(this.cid,this.commContent).then(function(t){n.findDyn(2)}):(0,i.addComment)(this.commContent,this.did).then(function(t){(0,i.getComment)(n.did).then(function(t){n.commentInfo=t,n.commContent=""}),(0,i.getBullet)(n.did).then(function(t){n.bulletList=t.content})}))},replyComm:function(t,e,i){i!=n.getStorageSync("USERS_KEY").id&&(this.commplaceholder="@"+e,this.addType="reply",this.cid=t)}},onShow:function(){this.findDyn(1)},onPullDownRefresh:function(){console.log("onPullDownRefresh"," at pages\\daily\\daily.vue:293"),setTimeout(function(){n.stopPullDownRefresh()},1e3)}};t.default=c}).call(this,e("6e42")["default"])},bfc9:function(n,t,e){"use strict";e.r(t);var i=e("959c"),o=e.n(i);for(var c in i)"default"!==c&&function(n){e.d(t,n,function(){return i[n]})}(c);t["default"]=o.a},eecd:function(n,t,e){}},[["494b","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/daily/userInfo"],{"1e82":function(n,t,e){},5053:function(n,t,e){"use strict";e.r(t);var o=e("f8e1"),u=e("6435");for(var i in u)"default"!==i&&function(n){e.d(t,n,function(){return u[n]})}(i);e("994a");var f=e("2877"),r=Object(f["a"])(u["default"],o["a"],o["b"],!1,null,"071170fa",null);t["default"]=r.exports},"57fa":function(n,t,e){"use strict";(function(n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;e("2f62");var o=e("d16c"),u={data:function(){return{userInfo:"",dynInfo:"",statusInfo:"",uid:""}},methods:{getUserInfo:function(){var n=this;(0,o.getInfo)(this.uid).then(function(t){n.userInfo=t}),(0,o.getDyn)(this.uid).then(function(t){n.dynInfo=t.resp})},preview:function(){var t=[this.userInfo.portrait];n.previewImage({urls:t,longPressActions:{itemList:["发送给朋友","保存图片","收藏"],success:function(n){console.log("选中了第"+(n.tapIndex+1)+"个按钮,第"+(n.index+1)+"张图片"," at pages\\daily\\userInfo.vue:61")},fail:function(n){console.log(n.errMsg," at pages\\daily\\userInfo.vue:64")}}})}},onLoad:function(n){this.uid=n.uid},onShow:function(){this.getUserInfo()}};t.default=u}).call(this,e("6e42")["default"])},6435:function(n,t,e){"use strict";e.r(t);var o=e("57fa"),u=e.n(o);for(var i in o)"default"!==i&&function(n){e.d(t,n,function(){return o[n]})}(i);t["default"]=u.a},"994a":function(n,t,e){"use strict";var o=e("1e82"),u=e.n(o);u.a},f8e1:function(n,t,e){"use strict";var o=function(){var n=this,t=n.$createElement;n._self._c},u=[];e.d(t,"a",function(){return o}),e.d(t,"b",function(){return u})}},[["8479","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/user/user"],{"088c":function(t,e,n){"use strict";n.r(e);var r=n("2b73"),a=n.n(r);for(var o in r)"default"!==o&&function(t){n.d(e,t,function(){return r[t]})}(o);e["default"]=a.a},"1b1a":function(t,e,n){"use strict";var r=function(){var t=this,e=t.$createElement;t._self._c},a=[];n.d(e,"a",function(){return r}),n.d(e,"b",function(){return a})},"2b73":function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var r=n("2f62"),a=n("d16c");function o(t){for(var e=1;e<arguments.length;e++){var n=null!=arguments[e]?arguments[e]:{},r=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(r=r.concat(Object.getOwnPropertySymbols(n).filter(function(t){return Object.getOwnPropertyDescriptor(n,t).enumerable}))),r.forEach(function(e){u(t,e,n[e])})}return t}function u(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}var i={data:function(){return{userInfo:"",socialInfo:"",userId:t.getStorageSync("USERS_KEY").id,avatar:"../../static/img/user/upload.svg",settings:[{src:"../../static/img/user/relNameAuth.svg",url:"../auth/auth",label:"實名認證",expla:"PAN幣綫上交易所交易需要實名認證"},{src:"../../static/img/user/invCode.svg",url:"../invite/invite",label:"我的邀請碼",expla:"獲得PAN幣和原力"},{src:"../../static/img/user/assetLedger.svg",url:"../ledger/asset",label:"資產賬本",expla:""},{src:"../../static/img/user/focusLedger.svg",url:"../ledger/focus",label:"原力賬本",expla:""},{src:"../../static/img/user/plantBase.svg",url:"../base/base",label:"星球基地",expla:""},{src:"../../static/img/user/option.svg",url:"../setting/setting",label:"設置",expla:""}]}},computed:o({},(0,r.mapState)(["hasLogin","forcedLogin"])),methods:o({},(0,r.mapMutations)(["logout"]),{bindLogout:function(){this.logout(),t.clearStorage("USERS_KEY"),t.reLaunch({url:"../login/login"})},getUserInfo:function(){var t=this;(0,a.findByID)().then(function(e){t.userInfo=e,t.avatar=e.portrait})},getSocialInfo:function(){var t=this;(0,a.getAllSocialInfo)().then(function(e){t.socialInfo=e})},uploadAvatar:function(){var t=this;(0,a.upPicture)(this.userId).then(function(e){t.avatar=e.id})}}),onShow:function(){this.getUserInfo(),this.getSocialInfo()}};e.default=i}).call(this,n("6e42")["default"])},"9cff":function(t,e,n){"use strict";var r=n("9f33"),a=n.n(r);a.a},"9f33":function(t,e,n){},d6fd:function(t,e,n){"use strict";n.r(e);var r=n("1b1a"),a=n("088c");for(var o in a)"default"!==o&&function(t){n.d(e,t,function(){return a[t]})}(o);n("9cff");var u=n("2877"),i=Object(u["a"])(a["default"],r["a"],r["b"],!1,null,"7d93fc3a",null);e["default"]=i.exports}},[["534f","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/invite/invite"],{"0748":function(e,t,n){"use strict";n.r(t);var o=n("64c2"),i=n.n(o);for(var a in o)"default"!==a&&function(e){n.d(t,e,function(){return o[e]})}(a);t["default"]=i.a},"64c2":function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=n("d16c"),i=n("f80b"),a=c(n("f1a9")),r=n("a39e");function c(e){return e&&e.__esModule?e:{default:e}}var u=function(){return Promise.all([n.e("common/vendor"),n.e("components/wm-poster/wm-poster")]).then(n.bind(null,"30fd"))},f={data:function(){return{assetInfo:"",listInfo:"",inviteCode:"",created:!1,createImg:""}},components:{wmPoster:u},methods:{getInvData:function(){var e=this;(0,i.invList)().then(function(t){e.listInfo=t}),(0,o.getInvCode)().then(function(t){e.inviteCode=t})},createPoster:function(){var e=this,t="http://pandla.io?invCode="+this.inviteCode,n=a.default.createQrCodeImg(t,{size:parseInt(300)});(0,r.base64ToPath)(n).then(function(t){console.log(t," at pages\\invite\\invite.vue:75"),e.createImg=t}).catch(function(e){console.error(e," at pages\\invite\\invite.vue:78")}),this.created=!0}},onLoad:function(){this.getInvData()}};t.default=f},"6ec7":function(e,t,n){"use strict";var o=n("7bbf"),i=n.n(o);i.a},"7bbf":function(e,t,n){},"85e3":function(e,t,n){"use strict";n.r(t);var o=n("eb5e"),i=n("0748");for(var a in i)"default"!==a&&function(e){n.d(t,e,function(){return i[e]})}(a);n("6ec7");var r=n("2877"),c=Object(r["a"])(i["default"],o["a"],o["b"],!1,null,"084a666e",null);t["default"]=c.exports},eb5e:function(e,t,n){"use strict";var o=function(){var e=this,t=e.$createElement;e._self._c},i=[];n.d(t,"a",function(){return o}),n.d(t,"b",function(){return i})}},[["db38","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/strategy/strategy"],{"128e":function(n,t,e){},a21a:function(n,t,e){"use strict";e.r(t);var u=e("b150"),a=e("e872");for(var r in a)"default"!==r&&function(n){e.d(t,n,function(){return a[n]})}(r);e("f9bd");var o=e("2877"),c=Object(o["a"])(a["default"],u["a"],u["b"],!1,null,null,null);t["default"]=c.exports},b150:function(n,t,e){"use strict";var u=function(){var n=this,t=n.$createElement;n._self._c},a=[];e.d(t,"a",function(){return u}),e.d(t,"b",function(){return a})},e7a7:function(n,t,e){},e872:function(n,t,e){"use strict";e.r(t);var u=e("e7a7"),a=e.n(u);for(var r in u)"default"!==r&&function(n){e.d(t,n,function(){return u[n]})}(r);t["default"]=a.a},f9bd:function(n,t,e){"use strict";var u=e("128e"),a=e.n(u);a.a}},[["6375","common/runtime","common/vendor"]]]);
});
