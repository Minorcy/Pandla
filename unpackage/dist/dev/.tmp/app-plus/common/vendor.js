...
=======
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.createDyn = exports.upload = exports.getImgTemp = exports.upPicture = exports.sysVote = exports.isVote = exports.toTreIndex = exports.checkForTaskList = exports.getForBill = exports.getForBalance = exports.checkTaskList = exports.getBill = exports.getBalance = exports.getPollTop = exports.donate = exports.getIndex = exports.concern = exports.addComment = exports.getComment = exports.findAllDyn = exports.getDyn = exports.getInfo = exports.upInfo = exports.getAllSocialInfo = exports.findByID = exports.changePwd = exports.register = exports.sendCode = exports.login = void 0;var Token = uni.getStorageSync('USERS_KEY').token;
...
exports.getComment = getComment;var addComment = function addComment(content, did) {return new Promise(function (resolve, reject) {
    console.log(did, " at api/api.js:348");
    uni.request({
...
/*********************PAN***************************/
// PAN公益首页数据
exports.concern = concern;var getIndex = function getIndex() {return new Promise(function (resolve, reject) {
    uni.request({
...
/*********************上传***************************/
// 上传头像
exports.sysVote = sysVote;var upPicture = function upPicture(userId) {return new Promise(function (resolve, reject) {
    uni.chooseImage({
      count: 1,
      ...
      success: function success(chooseImageRes) {
        ...
        var uploadTask = uni.uploadFile({
          ...
          name: 'file',
          success: function success(res) {
            console.log(res.data, " at api/api.js:690");
            var jsonObj = JSON.parse(res.data);
            console.log('uploadImage success, res is:', jsonObj.data, " at api/api.js:692");
            uni.showToast({
              title: '上传成功',
              icon: 'success',
              duration: 1000 });
          ...
          fail: function fail(err) {
            console.log('uploadImage fail', err, " at api/api.js:702");
            uni.showToast({
              icon: 'none',
        ...
        uploadTask.onProgressUpdate(function (res) {
          console.log('上传进度' + res.progress, " at api/api.js:710");
          console.log('已经上传的数据长度' + res.totalBytesSent, " at api/api.js:711");
          console.log('预期需要上传的数据总长度' + res.totalBytesExpectedToSend, " at api/api.js:712");
        });
      } });
...
exports.getImgTemp = getImgTemp;var upload = function upload(imgTemp) {return new Promise(function (resolve, reject) {
    uni.uploadFile({
      ...
      name: 'file',
      success: function success(res) {
        console.log(res.data, " at api/api.js:745");
        var jsonObj = JSON.parse(res.data);
        console.log('uploadImage success, res is:', jsonObj.data, " at api/api.js:747");
        console.log(jsonObj.data.id, " at api/api.js:748");
      ...
      fail: function fail(err) {
        console.log('uploadImage fail', err, " at api/api.js:759");
        uni.showToast({
          icon: 'none',
          title: '上传失败,请勿选择超过4M的图片' });
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.userValidate = exports.pwdValidate = exports.codeValidate = exports.joinValidate = exports.emailValidate = exports.phoneValidate = void 0;var pReg = /^[1](([3][0-9])|([4][5-9])|([5][0-3,5-9])|([6][5,6])|([7][0-8])|([8][0-9])|([9][1,8,9]))[0-9]{8}$/;
...
var _store = _interopRequireDefault(__webpack_require__(/*! ./store */ "../../../../../../Users/yanleilei/Documents/HBuilderProjects/panApp/xingjueApp/store/index.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.createDyn = exports.upload = exports.getImgTemp = exports.upPicture = exports.upLogo = exports.setBar = exports.getBarList = exports.sysVote = exports.isVote = exports.toTreIndex = exports.checkForTaskList = exports.getForBill = exports.getForBalance = exports.checkTaskList = exports.getBill = exports.getBalance = exports.getPollTop = exports.donate = exports.getIndex = exports.concern = exports.addComment = exports.getComment = exports.findAllDyn = exports.getDyn = exports.getInfo = exports.upInfo = exports.getAllSocialInfo = exports.findByID = exports.changePwd = exports.register = exports.sendCode = exports.login = void 0;var Token = uni.getStorageSync('USERS_KEY').token;
var systemUrl = 'http://printsn.com:8080/v1/system/';
var fansUrl = 'http://printsn.com:8080/v1/fans/';
var dynUrl = 'http://printsn.com:8080/v1/dyn/';
var pollUrl = 'http://printsn.com:8080/v1/poll/';
...
exports.getDyn = getDyn;var findAllDyn = function findAllDyn() {return new Promise(function (resolve, reject) {
    uni.request({
      ...
      success: function success(res) {
        console.log(res.data, " at api\\api.js:309");
        if (res.data.status == 200) resolve(res.data.data);
        // else reject(res.data.msg);
      },
      fail: function fail(err) {
...
exports.findAllDyn = findAllDyn;var getComment = function getComment(did) {return new Promise(function (resolve, reject) {
    ...
    uni.request({
      ...
      success: function success(res) {
        console.log(res.data, " at api\\api.js:332");
        if (res.data.status == 200) resolve(res.data.data.content);
        // if(res.data.status == 400) reject(0);
        // else reject(res.data.msg);
      },
...
// 用户评论
exports.getComment = getComment;var addComment = function addComment(content, did) {return new Promise(function (resolve, reject) {
    console.log(did, " at api\\api.js:349");
    uni.request({
      url: dynUrl + 'createCom?did=' + did + '&content=' + content,
      header: {
        'token': Token },
      ...
      success: function success(res) {
        console.log(res.data, " at api\\api.js:356");
        if (res.data.status == 200) resolve(res.data.data);
        // else reject(res.data.msg);
      },
      fail: function fail(err) {
...
exports.sysVote = sysVote;var getBarList = function getBarList(location) {return new Promise(function (resolve, reject) {
    uni.request({
      ...
      success: function success(res) {
        console.log(res.data, " at api\\api.js:686");
        if (res.data.status == 200) resolve(res.data.data);
        // else reject(res.data.msg);
      },
      fail: function fail(err) {
...
exports.setBar = setBar;var upLogo = function upLogo(imgTemp, type) {return new Promise(function (resolve, reject) {
    uni.uploadFile({
      ...
      fail: function fail(err) {
        console.log('uploadImage fail', err, " at api\\api.js:748");
        uni.showToast({
          icon: 'none',
          title: '上传失败,请勿选择超过4M的图片' });
    ...
    uni.chooseImage({
      ...
      success: function success(chooseImageRes) {
        ...
        var uploadTask = uni.uploadFile({
          ...
          name: 'file',
          success: function success(res) {
            console.log(res.data, " at api\\api.js:771");
            var jsonObj = JSON.parse(res.data);
            console.log('uploadImage success, res is:', jsonObj.data, " at api\\api.js:773");
            uni.showToast({
              title: '上传成功',
              icon: 'success',
              duration: 1000 });
          ...
          fail: function fail(err) {
            console.log('uploadImage fail', err, " at api\\api.js:783");
            uni.showToast({
              icon: 'none',
              title: '上传失败,请勿选择超过4M的图片' });
        ...
        uploadTask.onProgressUpdate(function (res) {
          console.log('上传进度' + res.progress, " at api\\api.js:791");
          console.log('已经上传的数据长度' + res.totalBytesSent, " at api\\api.js:792");
          console.log('预期需要上传的数据总长度' + res.totalBytesExpectedToSend, " at api\\api.js:793");
        });
      } });
...
exports.getImgTemp = getImgTemp;var upload = function upload(imgTemp) {return new Promise(function (resolve, reject) {
    uni.uploadFile({
      ...
      name: 'file',
      success: function success(res) {
        console.log(res.data, " at api\\api.js:826");
        var jsonObj = JSON.parse(res.data);
        console.log('uploadImage success, res is:', jsonObj.data, " at api\\api.js:828");
        console.log(jsonObj.data.id, " at api\\api.js:829");
        resolve(jsonObj.data.id);
        uni.showToast({
          icon: 'none',
          title: '發表成功' });
      ...
      fail: function fail(err) {
        console.log('uploadImage fail', err, " at api\\api.js:840");
        uni.showToast({
          icon: 'none',
          title: '上传失败,请勿选择超过4M的图片' });
