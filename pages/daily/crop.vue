	...
	<view class="container">
		<view class="page-body uni-content-info">
			<view class='cropper-content'>
				<view class="previewImage" v-if="!isShowImg">
					<image :src="imageSrc" mode="widthFix"></image>
					<view class="crop-btn" v-if="!isShowImg" @tap="crop()">
						<image src="../../static/img/daily/publish/crop.svg" mode="widthFix" />
					</view>
				</view>
				<view v-if="isShowImg" class="uni-corpper" :style="'width:'+cropperInitW+'px;height:'+cropperInitH+'px;background:#000'">
					...
					<view class="crop-btns" >
						<image src="../../static/img/daily/publish/cancel.svg" @click="cancel()" />
						<image src="../../static/img/daily/publish/confirm.svg" @click="getImageInfo()" />
					</view>
				</view>
			</view>
...
<script>
	...
	let SCREEN_HEIGHT = sysInfo.screenWidth
	let PAGE_X, // 手按下的x位置
		PAGE_Y, // 手按下y的位置
	...
	export default {
		...
		data() {
			return {
				imageSrc: this.$store.state.imgTemp,
				isShowImg: false,
				// 初始化的宽高
			...
			getImageInfo() {
				...
				ctx.draw(true, () => {
					...
					uni.canvasToTempFilePath({
						...
						width: canvasW,
						height: canvasH,
						destWidth: canvasW*PR,
						destHeight: canvasH*PR,
						quality: 1,
						canvasId: 'myCanvas',
						success: function(res) {
							uni.hideLoading()
							...
							// })
							_this.$store.commit('setImgTemp', res.tempFilePath);
