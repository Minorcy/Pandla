        ...
        <view class="input-group">
				<image class="img-avatar" :src="avatar" @tap="upLogoImg"/>
				 <view class="input-row border">
				    <m-input type="text" v-model="barInfo.name" placeholder="公益組織名稱" focus clearable></m-input>
				</view>
				<view class="input-row border">
				...
				<view class="input-row border">
					<m-input type="text" v-model="barInfo.intro" placeholder="公益組織簡介" clearable></m-input>
				</view>
				<view class="input-row border">
