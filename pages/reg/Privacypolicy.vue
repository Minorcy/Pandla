<template>
	<view>
		<text><text class="title">隱私條款</text>

			PANDLA非常重視你的隱私。因此我們制定了涵蓋如何使用以及存儲你的信息的隱私政策。請花些時間熟悉我們針對客戶隱私的做法，如有任何疑問，請聯繫我們。
			...
			Cookie 和其他技術
			PANDLA的網站、在線服務、互動應用軟件、電子郵件和廣告可能會使用 "Cookie" 和其他技術。此等技術幫助我們更好地了解用戶的行為，告訴我們人們瀏覽了我們網站的哪些部分，衡量廣告和網絡搜索的效果並加以改善。我們將通過
			...
			國際用戶
			如本隱私政策中所述，你提供的所有信息可能會被我們分散在世界各地的實體傳輸或訪問。 PANDLA遵守美國商務部製訂的 "安全港" 框架。
